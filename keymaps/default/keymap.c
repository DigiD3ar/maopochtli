...
[0] = LAYOUT(
    ...
    KC_TAB,     KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       MO(2),      MO(3),      MO(3),      MO(2),      KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_ENTER, \
    KC_LSFT,    KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       KC_LALT,                            KC_RALT,    KC_H,       KC_J,       KC_K,       KC_L,       KC_QUOTE,   KC_RSHIFT,\
